...
public section.
  ...
  types:
     TS_CUSTOMER type ZTXC_CUSTOMER_S. .
  types:
TT_CUSTOMER type standard table of TS_CUSTOMER. .
  ...
  types:
     TS_CUSTOMER_KNA1 type KNA1. .
  types:
TT_CUSTOMER_KNA1 type standard table of TS_CUSTOMER_KNA1. .

  constants GC_CUSTOMER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'customer' ##NO_TEXT.
  constants GC_CUSTOMER_KNA1 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'customer_kna1' ##NO_TEXT.
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZTXC_CUSTOMER_S'
...
***********************************************************************************************************************************
*   ENTITY - customer_kna1
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'customer_kna1' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Counc' iv_abap_fieldname = 'COUNC' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'customer_kna1Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210224204726'.                  "#EC NOTEXT
